/**
* Name: Load.h
* Purpose: Declaration of class Load
*
* @author Fenris
...
class Load{
    private:
        ...
        std::ifstream load;                                 ///<Loading file
    ...
    public:
        std::string fileName;                               ///<Name of file to load
        ...
        */
        Load(Textures &textures, ScoreDisplay &score_disp, ClockDisplay &clock_disp, LivesDisplay &lives, unsigned &wave_on, unsigned &score,
             unsigned &minutes, unsigned &seconds, unsigned &miliseconds);

        ///Reset Load to get specific type of drawing
        void reset();
